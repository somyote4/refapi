...
from blog.models import Post, Category, Tag, Goverment, Parameter
...
def post():
    ...
    if form.validate_on_submit():
        ...
        if form.new_parameter.data:
            new_parameter = Parameter(form.new_parameter.data)
        ...
        api_url = form.api_url.data.strip()
        api_request = form.api_request.data.strip()
        api_response = form.api_response.data.strip()
        post = Post(
            author=author,
            title=title,
            body=body,
